...
<body style="background-color: #666666;">
    ...
    <div class="limiter">
        <div class="container-login100 position-center ">
            <div class="wrap-login100">
                <form action="{{ route('registrasi') }}" class="login100-form validate-form" method="POST"
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Valid fullname is required: ade bot">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Valid nomor wa is required: 08427724724">
                        <input class="input100" type="text" name="nomor_wa">
                        <span class="focus-input100"></span>
                        <span class="label-input100">Nomor WA</span>
                    </div>
