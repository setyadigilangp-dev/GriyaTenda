...
<head>
    ...
    <title>Griya Tenda - Dashboard</title>
    ...
    <link href="{{ asset('halaman_dashboard/vendor/fontawesome-free/css/solid.css')}}" rel="stylesheet" type="text/css">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- Main Content -->
            <div id="content" class="bg-gray-700">
