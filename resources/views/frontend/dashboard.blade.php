@extends('layout.layout_user.index', ['page' => __('dashboard'), 'pageSlug' => 'dashboard'])
        ...
        <div class="row py-4">
            ...
            <div class=" col-lg-3 col-sm-6 col-12 pb-4">
                <div class=" pricing-detail py-5  text-center">
                    ...
                    <form action="{{ route('cart.add.specific', 35) }}" method="POST">
                        @csrf
            ...
            <div class=" col-lg-3 col-sm-6 col-12 pb-4">
                <div class=" pricing-detail py-5  text-center">
                    ...
                    <form action="{{ route('cart.add.specific', 36) }}" method="POST">
                        @csrf
                        <div class="pricing-button">
                            <button type="submit" class="btn btn-primary">Pilih Paket</button>
                        </div>
            ...
            <div class=" col-lg-3 col-sm-6 col-12 pb-4">
                <div class=" pricing-detail py-5  text-center">
                    ...
                    <form action="{{ route('cart.add.specific', 37) }}" method="POST">
                        @csrf
                        <div class="pricing-button">
                            <button type="submit" class="btn btn-primary">Pilih Paket</button>
                        </div>
